...
OHAS.df <- OHAS.df %>% filter(COUNTYNAME %in% c("Benton","Clackamas","Columbia","Deschutes","Jackson","Josephine","Lane","Linn","Marion","Multnomah","Polk","Washington"))

OHAS.df <- within(OHAS.df, COUNTYNAME <- factor(COUNTYNAME, levels = c("Benton","Clackamas","Columbia","Deschutes","Jackson","Josephine","Lane","Linn","Marion","Multnomah","Polk","Washington")))
